...
# Bad words list (expandable) - multi-language support
BAD_WORDS = [
    # English
    ...
    'ulol', 'inutil', 'pakyu', 'pakshet', 'punyeta', 'leche', 'letse',
    'tangina', 'yawa', 'animal', 'hayop', 'kupal', 'hinayupak', 'bwisit',
    'peste', 'lintik', 'siraulo', 'gunggong', 'engot', 'ungas', 'hudas',
    'demonyo', 'pisting yawa', 'kingina', 'kups', 'ogag', 'ampota',
    
    # Spanish
    'mierda', 'puto', 'perra', 'cabron', 'cabrón', 'pendejo', 'pendeja',
    'chingada', 'verga', 'coño', 'joder', 'gilipollas', 'imbecil', 'imbécil',
    'estupido', 'estúpido', 'idiota', 'maricon', 'maricón', 'zorra',
    
    # French
    'merde', 'putain', 'salaud', 'salope', 'connard', 'connasse',
    'enculé', 'bordel', 'nique', 'foutre', 'batard', 'bâtard', 'con',
    
    # German
    'scheiße', 'scheisse', 'arschloch', 'fick', 'ficken', 'hurensohn',
    'wichser', 'fotze', 'schlampe', 'dummkopf', 'idiot', 'depp',
    
    # Italian
    'cazzo', 'merda', 'stronzo', 'stronza', 'puttana', 'vaffanculo',
    'minchia', 'coglione', 'figlio di puttana', 'bastardo',
    
    # Portuguese
    'porra', 'caralho', 'foda', 'fodase', 'merda', 'puta', 'filho da puta',
    'cuzao', 'cuzão', 'otario', 'otário', 'viado', 'arrombado',
    
    # Japanese (romanized)
    'kuso', 'chikusho', 'baka', 'aho', 'shine', 'fuzakenna', 'kutabare',
    
    # Korean (romanized)
    'shibal', 'ssibal', 'gaesaekki', 'jot', 'byungshin', 'michin',
    
    # Chinese (romanized)
    'cao', 'tmd', 'sha bi', 'shabi', 'biao zi', 'hundan', 'wangbadan',
    
    # Arabic (romanized)
    'kuss', 'sharmouta', 'ibn el sharmouta', 'ya kalb', 'ya hmar',
]
